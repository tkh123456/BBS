<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('discuz');?><?php include template('common/header'); ?><div id="pt" class="newbm cl">
...
<?php if(empty($gid)) { ?>
<div id="chart" class="newbm bw0 cl">
