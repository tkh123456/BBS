...
0
|| checktplrefresh('./template/ahome_fenghua/common/header.htm', './template/default/common/header_common.htm', 1527520868, '4', './data/template/4_4_common_header_forum_index.tpl.php', './template/ahome_fenghua', 'common/header_forum_index')
|| checktplrefresh('./template/ahome_fenghua/common/header.htm', './template/default/common/header_qmenu.htm', 1527520868, '4', './data/template/4_4_common_header_forum_index.tpl.php', './template/ahome_fenghua', 'common/header_forum_index')
|| checktplrefresh('./template/ahome_fenghua/common/header.htm', './template/ahome_fenghua/common/pubsearchform.htm', 1527520868, '4', './data/template/4_4_common_header_forum_index.tpl.php', './template/ahome_fenghua', 'common/header_forum_index')
;?>
