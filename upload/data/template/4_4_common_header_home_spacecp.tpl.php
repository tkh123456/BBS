...
0
|| checktplrefresh('./template/ahome_fenghua/common/header.htm', './template/default/common/header_common.htm', 1527588514, '4', './data/template/4_4_common_header_home_spacecp.tpl.php', './template/ahome_fenghua', 'common/header_home_spacecp')
|| checktplrefresh('./template/ahome_fenghua/common/header.htm', './template/default/common/header_qmenu.htm', 1527588514, '4', './data/template/4_4_common_header_home_spacecp.tpl.php', './template/ahome_fenghua', 'common/header_home_spacecp')
|| checktplrefresh('./template/ahome_fenghua/common/header.htm', './template/ahome_fenghua/common/pubsearchform.htm', 1527588514, '4', './data/template/4_4_common_header_home_spacecp.tpl.php', './template/ahome_fenghua', 'common/header_home_spacecp')
;?>
...
<div style="float:right;"><?php include template('common/header_userstatus'); ?></div>
</div>
</div>
...
<div class="wp"><?php $mnid = getcurrentnav();?><center><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></center>
<div class="fr"><?php if($_G['setting']['search']) { $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
