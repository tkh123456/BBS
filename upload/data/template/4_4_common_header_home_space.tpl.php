...
0
|| checktplrefresh('./template/ahome_fenghua/common/header.htm', './template/default/common/header_common.htm', 1527588502, '4', './data/template/4_4_common_header_home_space.tpl.php', './template/ahome_fenghua', 'common/header_home_space')
|| checktplrefresh('./template/ahome_fenghua/common/header.htm', './template/default/common/header_qmenu.htm', 1527588502, '4', './data/template/4_4_common_header_home_space.tpl.php', './template/ahome_fenghua', 'common/header_home_space')
|| checktplrefresh('./template/ahome_fenghua/common/header.htm', './template/ahome_fenghua/common/pubsearchform.htm', 1527588502, '4', './data/template/4_4_common_header_home_space.tpl.php', './template/ahome_fenghua', 'common/header_home_space')
;?>
