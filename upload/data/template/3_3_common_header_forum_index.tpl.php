...
0
|| checktplrefresh('./template/rabbit_bc/common/header.htm', './template/default/common/header_common.htm', 1527520860, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/rabbit_bc', 'common/header_forum_index')
|| checktplrefresh('./template/rabbit_bc/common/header.htm', './template/default/common/header_qmenu.htm', 1527520860, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/rabbit_bc', 'common/header_forum_index')
|| checktplrefresh('./template/rabbit_bc/common/header.htm', './template/rabbit_bc/common/pubsearchform.htm', 1527520860, '3', './data/template/3_3_common_header_forum_index.tpl.php', './template/rabbit_bc', 'common/header_forum_index')
;?>
...
<?php echo $diynav;?>
<?php } if(empty($_G['disabledwidthauto']) && $_G['setting']['switchwidthauto']) { ?> 						<a href="javascript:;" id="switchwidth" onclick="widthauto(this)" title="<?php if(widthauto()) { ?>切换到窄版<?php } else { ?>切换到宽版<?php } ?>" class="switchwidth"<?php if($_G['uid']) { } else { ?>style="margin-top:9px !important;"<?php } ?>><?php if(widthauto()) { ?>切换到窄版<?php } else { ?>切换到宽版<?php } ?></a> 					<?php } ?>
